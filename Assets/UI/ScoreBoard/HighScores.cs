...
{
    const string privateCode = "07Id6rs0Q0aQvufC1Fpj2AIhT3cQnJNEizJz0jqqso9A";  //Key to Upload New Info
    const string publicCode = "62d848f38f40bb84ec7a1fb1";   //Key to download
    ...
    IEnumerator DatabaseDownload()
    {
        ...
        WWW webRequest = new WWW(webURL + publicCode + "/pipe/0/10"); //Gets top 10
